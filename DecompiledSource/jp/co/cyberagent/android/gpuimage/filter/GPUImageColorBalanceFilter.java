...
public class GPUImageColorBalanceFilter extends GPUImageFilter {
  ...
  public void setHighlights(float[] paramArrayOffloat) {
    this.highlights = paramArrayOffloat;
    setFloatVec3(this.highlightsLocation, paramArrayOffloat);
  }
  
  public void setMidtones(float[] paramArrayOffloat) {
    this.midtones = paramArrayOffloat;
    setFloatVec3(this.midtonesLocation, paramArrayOffloat);
  }
  
  public void setPreserveLuminosity(boolean paramBoolean) {
    this.preserveLuminosity = paramBoolean;
    setInteger(this.preserveLuminosityLocation, paramBoolean);
  }
  
  public void setShowdows(float[] paramArrayOffloat) {
    this.showdows = paramArrayOffloat;
    setFloatVec3(this.shadowsLocation, paramArrayOffloat);
  }
}


/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/jp/co/cyberagent/android/gpuimage/filter/GPUImageColorBalanceFilter.class
