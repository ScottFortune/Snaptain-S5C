...
public class GPUImageFilterGroup extends GPUImageFilter {
  ...
  public GPUImageFilterGroup(List<GPUImageFilter> paramList) {
  ...
  public void updateMergedFilters() {
    ...
    for (GPUImageFilter gPUImageFilter : this.filters) {
      List<GPUImageFilter> list1;
      if (gPUImageFilter instanceof GPUImageFilterGroup) {
        gPUImageFilter = gPUImageFilter;
        gPUImageFilter.updateMergedFilters();
        list1 = gPUImageFilter.getMergedFilters();
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/jp/co/cyberagent/android/gpuimage/filter/GPUImageFilterGroup.class
