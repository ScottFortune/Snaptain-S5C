...
public class HYPacketSplitter {
  ...
  public HYPacketSplitter(Callback paramCallback) {
  ...
  private boolean isPackageStart(byte paramByte) {
    ...
    if ((i == 0 || i == 1) && paramByte == 88) {
      ...
      if (this.state == 1 && paramByte == -117) {
        ...
        if (this.state == 3 && paramByte == 14) {
          this.suspectPackageSize = 18;
          return true;
        } 
          ...
          if (this.state == 1 && paramByte == -115) {
            ...
            if (this.state == 1 && paramByte == -124) {
              ...
              if (this.state == 1 && paramByte == -114) {
                ...
                if (this.state == 7 && paramByte == 4) {
                  this.suspectPackageSize = 8;
                  return true;
                } 
                if (this.state == 1 && paramByte == -113) {
                  this.state = 8;
                } else {
                  if (this.state == 8 && paramByte == 8) {
                    this.suspectPackageSize = 12;
                    return true;
                  } 
                  if (this.state == 1 && paramByte == -111) {
                    this.state = 9;
                  } else {
                    if (this.state == 9 && paramByte == 19) {
                      this.suspectPackageSize = 23;
                      return true;
                    } 
                    this.state = 0;
                  } 
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/com/netopsun/rxtxprotocol/hy_blue_light_gps_protocol/HYPacketSplitter.class
