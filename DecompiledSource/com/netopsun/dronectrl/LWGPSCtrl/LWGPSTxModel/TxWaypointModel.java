...
public class TxWaypointModel extends TxModel {
  ...
  public int[] modelValues() {
    return new int[] { this.waypointGpsLat, this.waypointGpsLon, this.waypointH, 2 };
  }
  
  public int[] rawByteLens() {
    return new int[] { 4, 4, 1, 1 };
  }
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/com/netopsun/dronectrl/LWGPSCtrl/LWGPSTxModel/TxWaypointModel.class
