    ...
    synchronized (this.dateFormats) {
      ...
      while (true) {
        ...
        try {
          ...
          this(0);
          return ISO8601Utils.parse(paramString, parsePosition);
        } catch (ParseException parseException) {
          JsonSyntaxException jsonSyntaxException = new JsonSyntaxException();
          this(paramString, parseException);
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/com/google/gson/DefaultDateTypeAdapter.class
