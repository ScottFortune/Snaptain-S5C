...
public final class Excluder implements TypeAdapterFactory, Cloneable {
  ...
  public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> type) {
    ...
    if (bool || excludeClassInStrategy(clazz, true)) {
      bool1 = true;
    } else {
      bool1 = false;
    } 
    if (bool || excludeClassInStrategy(clazz, false)) {
      bool = true;
    } else {
      bool = false;
    } 
    return (!bool1 && !bool) ? null : new TypeAdapter<T>() {
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/com/google/gson/internal/Excluder.class
