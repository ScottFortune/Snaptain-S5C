...
public class Toolbar extends ViewGroup {
    ...
    if (paramBoolean || bool) {
      ...
      if (i) {
        ...
        if (paramBoolean) {
          ...
          i3 = i + layoutParams1.bottomMargin;
        } else {
          i = paramInt2;
          i3 = paramInt1;
          paramInt1 = i;
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    if (shouldLayout((View)this.mMenuView)) {
      ...
      m = Math.max(i2, this.mMenuView.getMeasuredHeight() + getVerticalMargins((View)this.mMenuView));
    ...
    int m = getCurrentContentInsetEnd();
    int i = i3 + Math.max(m, i2);
    arrayOfInt[j] = Math.max(0, m - i2);
    int j = i;
    m = n;
    i2 = k;
    if (shouldLayout(this.mExpandedActionView)) {
      j = i + measureChildCollapseMargins(this.mExpandedActionView, paramInt1, i, paramInt2, 0, arrayOfInt);
      m = Math.max(n, this.mExpandedActionView.getMeasuredHeight() + getVerticalMargins(this.mExpandedActionView));
      i2 = View.combineMeasuredStates(k, this.mExpandedActionView.getMeasuredState());
    } 
    i = j;
    n = m;
    k = i2;
    if (shouldLayout((View)this.mLogoView)) {
      ...
      k = View.combineMeasuredStates(i2, this.mLogoView.getMeasuredState());
    } 
    i3 = getChildCount();
    m = i;
    i2 = 0;
    ...
    paramInt1 = View.resolveSizeAndState(Math.max(i2 + j + i, getSuggestedMinimumHeight()), paramInt2, k << 16);
    if (shouldCollapse())
      paramInt1 = 0; 
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/appcompat/widget/Toolbar.class
