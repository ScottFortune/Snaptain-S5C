      ...
      if (param1VPath.isClipPath()) {
        ...
        if (((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathStart != 0.0F || ((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathEnd != 1.0F) {
          ...
          if (f5 > f7) {
            ...
            this.mPathMeasure.getSegment(0.0F, f7, path2, true);
          } else {
            this.mPathMeasure.getSegment(f5, f7, path2, true);
          } 
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/vectordrawable/graphics/drawable/VectorDrawableCompat.class
