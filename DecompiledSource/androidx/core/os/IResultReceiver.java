  ...
  public static abstract class Stub extends Binder implements IResultReceiver {
    ...
    public static IResultReceiver asInterface(IBinder param1IBinder) {
      if (param1IBinder == null)
        return null; 
      IInterface iInterface = param1IBinder.queryLocalInterface("androidx.core.os.IResultReceiver");
    ...
    public boolean onTransact(int param1Int1, Parcel param1Parcel1, Parcel param1Parcel2, int param1Int2) throws RemoteException {
      if (param1Int1 != 1) {
        ...
        param1Parcel2.writeString("androidx.core.os.IResultReceiver");
        return true;
      } 
      param1Parcel1.enforceInterface("androidx.core.os.IResultReceiver");
    ...
    private static class Proxy implements IResultReceiver {
      ...
      public void send(int param2Int, Bundle param2Bundle) throws RemoteException {
        ...
        try {
          parcel.writeInterfaceToken("androidx.core.os.IResultReceiver");
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/core/os/IResultReceiver.class
