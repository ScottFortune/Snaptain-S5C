...
public class NotificationCompat {
    ...
    private Bitmap reduceLargeIconSize(Bitmap param1Bitmap) {
      ...
      if (param1Bitmap != null)
        if (Build.VERSION.SDK_INT >= 27) {
          ...
          Double.isNaN(d3);
          Double.isNaN(d2);
          d2 = Math.min(d1, d3 / d2);
          d1 = param1Bitmap.getWidth();
          Double.isNaN(d1);
          j = (int)Math.ceil(d1 * d2);
          d1 = param1Bitmap.getHeight();
          Double.isNaN(d1);
          bitmap = Bitmap.createScaledBitmap(param1Bitmap, j, (int)Math.ceil(d1 * d2), true);
        }  
      return bitmap;
    }
  ...
  public static class DecoratedCustomViewStyle extends Style {
    ...
    private RemoteViews createRemoteViews(RemoteViews param1RemoteViews, boolean param1Boolean) {
      ...
      //   74: aload_0
      //   75: aload_0
      //   76: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   79: getfield mActions : Ljava/util/ArrayList;
      //   82: iload_3
      //   83: invokevirtual get : (I)Ljava/lang/Object;
      //   86: checkcast androidx/core/app/NotificationCompat$Action
      //   89: invokespecial generateActionButton : (Landroidx/core/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;
      //   92: astore #9
      //   94: aload #6
      //   96: getstatic androidx/core/R$id.actions : I
      //   99: aload #9
  ...
  public static abstract class Style {
    ...
    public RemoteViews applyStandardTemplate(boolean param1Boolean1, int param1Int, boolean param1Boolean2) {
      ...
      //   350: istore #9
      //   352: aload #4
      //   354: getstatic androidx/core/R$dimen.notification_big_circle_margin : I
      //   357: invokevirtual getDimensionPixelSize : (I)I
      //   360: istore #7
      //   362: aload #4
      //   364: getstatic androidx/core/R$dimen.notification_small_icon_size_as_large : I
      ...
      //   873: goto -> 903
      //   876: aload #5
      //   878: getstatic androidx/core/R$id.time : I
      //   881: iconst_0
      //   882: invokevirtual setViewVisibility : (II)V
      //   885: aload #5
      //   887: getstatic androidx/core/R$id.time : I
      //   890: ldc_w 'setTime'
      //   893: aload_0
      //   894: getfield mBuilder : Landroidx/core/app/NotificationCompat$Builder;
      //   897: invokevirtual getWhenIfShowing : ()J
      //   900: invokevirtual setLong : (ILjava/lang/String;J)V
      //   903: iconst_1
      //   904: istore_2
      //   905: getstatic androidx/core/R$id.right_side : I
      //   908: istore #9
      //   910: iload_2
      //   911: ifeq -> 919
      //   914: iconst_0
      ...
      //   930: getstatic androidx/core/R$id.line3 : I
      //   933: istore #9
      //   935: iload #7
      //   937: ifeq -> 946
      //   940: iload #6
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/core/app/NotificationCompat.class
