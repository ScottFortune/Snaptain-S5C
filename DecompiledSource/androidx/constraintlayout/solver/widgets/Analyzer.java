...
public class Analyzer {
  ...
  private static int getMaxDimensionTraversal(ConstraintWidget paramConstraintWidget, int paramInt1, boolean paramBoolean, int paramInt2) {
    ...
    int k = Math.max(i, Math.max(i5, paramInt2));
    int m = i2 + i4;
    int j = m;
    paramInt2 = i2;
    if (b == -1) {
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/constraintlayout/solver/widgets/Analyzer.class
