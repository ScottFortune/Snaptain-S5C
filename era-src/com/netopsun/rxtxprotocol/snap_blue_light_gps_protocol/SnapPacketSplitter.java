...
public class SnapPacketSplitter {
  ...
  public SnapPacketSplitter(Callback paramCallback) {
        ...
        if (this.state == 1 && paramByte == -116) {
          ...
          if (this.state == 1 && paramByte == -115) {
            ...
            if (this.state == 1 && paramByte == -124) {
              ...
              if (this.state == 1 && paramByte == -114) {
                this.state = 7;
              } else {
                if (this.state == 7 && paramByte == 2) {
                  this.suspectPackageSize = 6;
                  return true;
                } 
                this.state = 0;
              } 
  ...
  public void onByte(byte paramByte) {
    ...
    if (isPackageStart(paramByte)) {
      ...
      byte[] arrayOfByte1 = this.head;
      arrayOfByte[0] = (byte)arrayOfByte1[0];
      arrayOfByte[1] = (byte)arrayOfByte1[1];
      AbstractMap.SimpleEntry<byte, Integer> simpleEntry = new AbstractMap.SimpleEntry<byte, Integer>(arrayOfByte, Integer.valueOf(2));
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/com/netopsun/rxtxprotocol/snap_blue_light_gps_protocol/SnapPacketSplitter.class
