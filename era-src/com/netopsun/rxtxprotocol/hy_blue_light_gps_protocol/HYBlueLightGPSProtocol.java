...
public class HYBlueLightGPSProtocol extends RxTxProtocol {
  ...
  private final HYReceiveDataAnalyzer receiveDataAnalyzer = new HYReceiveDataAnalyzer();
  
  private Disposable sendWayPointsTask;
  
  public HYBlueLightGPSProtocol(RxTxCommunicator paramRxTxCommunicator) {
    ...
    paramRxTxCommunicator.setOnReceiveCallback(new RxTxCommunicator.OnReceiveCallback() {
          public void onReceive(byte[] param1ArrayOfbyte) {
            HYBlueLightGPSProtocol.this.receiveDataAnalyzer.parseData(param1ArrayOfbyte, param1ArrayOfbyte.length);
          }
        });
  }
  ...
  private void sendWayPointCmd(int paramInt1, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, int paramInt2) {
    ...
    i = arrayOfByte[13];
    arrayOfByte[13] = (byte)(byte)((byte)(paramInt1 << 1) | i);
  ...
  public void notifySend() {
    ...
    if (this.unlocked == 1) {
      arrayOfByte = this.bytes;
      arrayOfByte[9] = (byte)(byte)(0x4 | arrayOfByte[9]);
    } 
    if (this.takeOff == 1) {
      arrayOfByte = this.bytes;
  ...
  public void setAroundMode(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$1102(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setCalibration(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$202(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setCompassCalibration(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$302(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setEmergencyStop(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$602(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setFlyback(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$802(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setFollowedMeMode(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$1202(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setLanding(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$502(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setNormalFlyMode(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$102(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  
  public void setReadBatteryMode(int paramInt) {
    this.receiveDataAnalyzer.setReadBatteryMode(paramInt);
  }
  ...
  public void setTakeOff(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$402(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
  ...
  public void setUnlocked(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$702(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
    ...
    this.sendWayPointsTask = Observable.create(new ObservableOnSubscribe<Object>() {
          public void subscribe(ObservableEmitter<Object> param1ObservableEmitter) throws Exception {
            ...
            while (i < wayPoints.length && !param1ObservableEmitter.isDisposed()) {
              HYBlueLightGPSProtocol.this.sendWayPointCmd(i, wayPointLocations[i].getLatitude(), wayPointLocations[i].getLongitude(), wayPointLocations[i].getSpeed(), wayPointLocations[i].getAltitude(), (int)wayPointLocations[i].getTime());
              int k = 0;
              while (true) {
  ...
  public void setWayPointMode(boolean paramBoolean) {
    ...
    Observable.timer(1L, TimeUnit.SECONDS).subscribe(new Consumer<Long>() {
          public void accept(Long param1Long) throws Exception {
            HYBlueLightGPSProtocol.access$1002(HYBlueLightGPSProtocol.this, 0);
          }
        });
  }
}
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/com/netopsun/rxtxprotocol/hy_blue_light_gps_protocol/HYBlueLightGPSProtocol.class
