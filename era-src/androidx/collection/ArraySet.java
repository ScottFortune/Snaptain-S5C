  ...
  public E removeAt(int paramInt) {
    ...
    if (i <= 1) {
      ...
      if (j > 8 && i < arrayOfInt.length / 3) {
        ...
        if (paramInt < k) {
          i = paramInt + 1;
          System.arraycopy(arrayOfInt1, i, this.mHashes, paramInt, k - paramInt);
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/collection/ArraySet.class
