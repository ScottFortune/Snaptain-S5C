        ...
        if (resolutionAnchor != null) {
          ...
          if (resolutionAnchor != null && resolutionAnchor.state == 1) {
            ...
            if (this.myAnchor.mType == ConstraintAnchor.Type.LEFT || this.myAnchor.mType == ConstraintAnchor.Type.RIGHT) {
              f1 = f2 - this.myAnchor.mOwner.getWidth();
              f2 = this.myAnchor.mOwner.mHorizontalBiasPercent;
            } else {
              f1 = f2 - this.myAnchor.mOwner.getHeight();
            ...
            if (i != 0) {
              ...
              resolutionAnchor1.resolvedOffset = resolutionAnchor1.target.resolvedOffset + f4 + f1 * f2;
              this.resolvedOffset = this.target.resolvedOffset - f3 - f1 * (1.0F - f2);
            } else {
              this.resolvedOffset = this.target.resolvedOffset + f3 + f1 * f2;
              ResolutionAnchor resolutionAnchor1 = this.opposite;
              resolutionAnchor1.resolvedOffset = resolutionAnchor1.target.resolvedOffset - f4 - f1 * (1.0F - f2);
            } 
            didResolve();
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/constraintlayout/solver/widgets/ResolutionAnchor.class
