...
class ChildHelper {
  ...
  static class Bucket {
    ...
    boolean remove(int param1Int) {
      ...
      l1--;
      long l2 = this.mData;
      this.mData = Long.rotateRight(l2 & (l1 ^ 0xFFFFFFFFFFFFFFFFL), 1) | l2 & l1;
      Bucket bucket = this.mNext;
      if (bucket != null) {
        if (bucket.get(0))
          set(63); 
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/recyclerview/widget/ChildHelper.class
