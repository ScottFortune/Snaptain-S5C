...
public class AnimatedStateListDrawableCompat extends StateListDrawable implements TintAwareDrawable {
  ...
  private int parseItem(Context paramContext, Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme) throws XmlPullParserException, IOException {
    ...
    if (context == null)
      while (true) {
        ...
        if (stringBuilder1 != null)
          return this.mState.addStateSet(arrayOfInt, (Drawable)stringBuilder1, i); 
    ...
    if (xmlPullParserException2 != null)
      return this.mState.addStateSet(arrayOfInt, (Drawable)xmlPullParserException2, i); 
    StringBuilder stringBuilder = new StringBuilder();
    stringBuilder.append(paramXmlPullParser.getPositionDescription());
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat.class
