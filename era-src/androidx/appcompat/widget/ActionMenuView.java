      ...
      while (paramInt1 < i) {
        ...
        if (view.getVisibility() != 8)
          if (layoutParams.isOverflowButton) {
            ...
            int i1 = j - paramInt3 / 2;
            view.layout(paramInt2 - paramInt4, i1, paramInt2, paramInt3 + i1);
            paramInt3 = paramInt2 - paramInt4 + layoutParams.leftMargin + n;
          }  
        paramInt1++;
        paramInt2 = paramInt3;
      } 
      ...
      while (paramInt1 < i) {
        ...
        if (view.getVisibility() != 8)
          if (layoutParams.isOverflowButton) {
            ...
            paramInt4 = j - i1 / 2;
            view.layout(paramInt2, paramInt4, paramInt2 + paramInt3, i1 + paramInt4);
            paramInt3 = paramInt2 + paramInt3 + layoutParams.rightMargin + n;
          }  
        paramInt1++;
        paramInt2 = paramInt3;
      } 
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/appcompat/widget/ActionMenuView.class
