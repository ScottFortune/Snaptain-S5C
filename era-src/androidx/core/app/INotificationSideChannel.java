  ...
  public static abstract class Stub extends Binder implements INotificationSideChannel {
    ...
    public static INotificationSideChannel asInterface(IBinder param1IBinder) {
      if (param1IBinder == null)
        return null; 
      IInterface iInterface = param1IBinder.queryLocalInterface("androidx.core.app.INotificationSideChannel");
      ...
      if (param1Int1 != 1) {
        if (param1Int1 != 2) {
          if (param1Int1 != 3) {
            ...
            param1Parcel2.writeString("androidx.core.app.INotificationSideChannel");
            return true;
          } 
          param1Parcel1.enforceInterface("androidx.core.app.INotificationSideChannel");
    ...
    private static class Proxy implements INotificationSideChannel {
      ...
      public void cancel(String param2String1, int param2Int, String param2String2) throws RemoteException {
        ...
        try {
          parcel.writeInterfaceToken("androidx.core.app.INotificationSideChannel");
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/core/app/INotificationSideChannel.class
