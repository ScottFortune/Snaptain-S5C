  ...
  public static void onNestedScrollAccepted(ViewParent paramViewParent, View paramView1, View paramView2, int paramInt1, int paramInt2) {
    if (paramViewParent instanceof NestedScrollingParent2) {
      ...
      if (Build.VERSION.SDK_INT >= 21) {
        ...
        ((NestedScrollingParent)paramViewParent).onNestedScrollAccepted((View)stringBuilder, (View)abstractMethodError, paramInt1);
      } 
    } 
  }
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/core/view/ViewParentCompat.class
