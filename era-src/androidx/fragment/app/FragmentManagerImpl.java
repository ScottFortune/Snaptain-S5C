...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
  ...
  void restoreSaveState(Parcelable paramParcelable) {
    ...
    //   386: aload #5
    //   388: aload_0
    //   389: getfield mHost : Landroidx/fragment/app/FragmentHostCallback;
    //   392: invokevirtual getContext : ()Landroid/content/Context;
    //   395: invokevirtual getClassLoader : ()Ljava/lang/ClassLoader;
    //   398: aload_0
    //   399: invokevirtual getFragmentFactory : ()Landroidx/fragment/app/FragmentFactory;
    //   402: invokevirtual instantiate : (Ljava/lang/ClassLoader;Landroidx/fragment/app/FragmentFactory;)Landroidx/fragment/app/Fragment;
    //   405: astore #4
    //   407: aload #4
    //   409: aload_0
    ...
    //   426: astore_3
    //   427: aload_3
    //   428: ldc_w 'restoreSaveState: active ('
    ...
    //   485: aload #5
    //   487: aconst_null
    //   488: putfield mInstance : Landroidx/fragment/app/Fragment;
    //   491: goto -> 361
    //   494: aload_0
    //   495: getfield mAdded : Ljava/util/ArrayList;
    //   498: invokevirtual clear : ()V
    //   501: aload_2
    //   502: getfield mAdded : Ljava/util/ArrayList;
    //   505: ifnull -> 742
    //   508: aload_2
    //   509: getfield mAdded : Ljava/util/ArrayList;
    ...
    //   537: astore_3
    //   538: aload_0
    //   539: getfield mActive : Ljava/util/HashMap;
    //   542: aload_3
    ...
    //   587: pop
    //   588: aload_0
    //   589: new java/lang/IllegalStateException
    //   592: dup
    //   593: aload #4
    ...
    //   622: astore #4
    //   624: aload #4
    //   626: ldc_w 'restoreSaveState: added ('
    ...
    //   655: pop
    //   656: ldc 'FragmentManager'
    //   658: aload #4
    //   660: invokevirtual toString : ()Ljava/lang/String;
    //   663: invokestatic v : (Ljava/lang/String;Ljava/lang/String;)I
    //   666: pop
    //   667: aload_0
    //   668: getfield mAdded : Ljava/util/ArrayList;
    //   671: aload_1
    //   672: invokevirtual contains : (Ljava/lang/Object;)Z
    //   675: ifne -> 704
    //   678: aload_0
    //   679: getfield mAdded : Ljava/util/ArrayList;
    //   682: astore_3
    //   683: aload_3
    //   684: monitorenter
    //   685: aload_0
    ...
    //   689: aload_1
    //   690: invokevirtual add : (Ljava/lang/Object;)Z
    //   693: pop
    //   694: aload_3
    //   695: monitorexit
    //   696: goto -> 517
    ...
    //   741: athrow
    //   742: aload_2
    //   743: getfield mBackStack : [Landroidx/fragment/app/BackStackState;
    //   746: ifnull -> 932
    //   749: aload_0
    //   750: new java/util/ArrayList
    //   753: dup
    //   754: aload_2
    //   755: getfield mBackStack : [Landroidx/fragment/app/BackStackState;
    //   758: arraylength
    //   759: invokespecial <init> : (I)V
    //   762: putfield mBackStack : Ljava/util/ArrayList;
    //   765: iconst_0
    //   766: istore #6
    //   768: iload #6
    //   770: aload_2
    //   771: getfield mBackStack : [Landroidx/fragment/app/BackStackState;
    //   774: arraylength
    //   775: if_icmpge -> 937
    //   778: aload_2
    ...
    //   784: aaload
    //   785: aload_0
    //   786: invokevirtual instantiate : (Landroidx/fragment/app/FragmentManagerImpl;)Landroidx/fragment/app/BackStackRecord;
    //   789: astore_1
    //   790: getstatic androidx/fragment/app/FragmentManagerImpl.DEBUG : Z
    //   793: ifeq -> 901
    ...
    //   803: astore #5
    //   805: aload #5
    //   807: ldc_w 'restoreAllState: back stack #'
    //   810: invokevirtual append : (Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   813: pop
    //   814: aload #5
    //   816: iload #6
    //   818: invokevirtual append : (I)Ljava/lang/StringBuilder;
    //   821: pop
    //   822: aload #5
    //   824: ldc_w ' (index '
    ...
    //   864: invokestatic v : (Ljava/lang/String;Ljava/lang/String;)I
    //   867: pop
    //   868: new java/io/PrintWriter
    //   871: dup
    //   872: new androidx/core/util/LogWriter
    //   875: dup
    //   876: ldc 'FragmentManager'
    //   878: invokespecial <init> : (Ljava/lang/String;)V
    //   881: invokespecial <init> : (Ljava/io/Writer;)V
    //   884: astore #5
    //   886: aload_1
    //   887: ldc_w '  '
    //   890: aload #5
    //   892: iconst_0
    //   893: invokevirtual dump : (Ljava/lang/String;Ljava/io/PrintWriter;Z)V
    //   896: aload #5
    //   898: invokevirtual close : ()V
    //   901: aload_0
    //   902: getfield mBackStack : Ljava/util/ArrayList;
    //   905: aload_1
    //   906: invokevirtual add : (Ljava/lang/Object;)Z
    //   909: pop
    //   910: aload_1
    //   911: getfield mIndex : I
    //   914: iflt -> 926
    //   917: aload_0
    //   918: aload_1
    //   919: getfield mIndex : I
    //   922: aload_1
    //   923: invokevirtual setBackStackIndex : (ILandroidx/fragment/app/BackStackRecord;)V
    //   926: iinc #6, 1
    //   929: goto -> 768
    //   932: aload_0
    //   933: aconst_null
    //   934: putfield mBackStack : Ljava/util/ArrayList;
    //   937: aload_2
    //   938: getfield mPrimaryNavActiveWho : Ljava/lang/String;
    //   941: ifnull -> 970
    //   944: aload_0
    //   945: aload_0
    //   946: getfield mActive : Ljava/util/HashMap;
    //   949: aload_2
    //   950: getfield mPrimaryNavActiveWho : Ljava/lang/String;
    //   953: invokevirtual get : (Ljava/lang/Object;)Ljava/lang/Object;
    //   956: checkcast androidx/fragment/app/Fragment
    //   959: putfield mPrimaryNav : Landroidx/fragment/app/Fragment;
    //   962: aload_0
    //   963: aload_0
    //   964: getfield mPrimaryNav : Landroidx/fragment/app/Fragment;
    //   967: invokespecial dispatchParentPrimaryNavigationFragmentChanged : (Landroidx/fragment/app/Fragment;)V
    //   970: aload_0
    //   971: aload_2
    //   972: getfield mNextFragmentIndex : I
    //   975: putfield mNextFragmentIndex : I
    //   978: return
    // Exception table:
    //   from	to	target	type
    //   685	696	699	finally
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/androidx/fragment/app/FragmentManagerImpl.class
