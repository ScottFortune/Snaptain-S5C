...
public class IjkMediaMeta {
  ...
  public static IjkMediaMeta parse(Bundle paramBundle) {
    ...
    int j = ijkMediaMeta.getInt("audio", -1);
    ...
    for (Bundle bundle : arrayList) {
      ...
      if (bundle == null)
        continue; 
      IjkStreamMeta ijkStreamMeta = new IjkStreamMeta(b);
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/tv/danmaku/ijk/media/player_gx/IjkMediaMeta.class
