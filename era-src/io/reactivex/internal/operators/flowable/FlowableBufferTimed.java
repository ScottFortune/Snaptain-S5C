...
public final class FlowableBufferTimed<T, U extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, U> {
  ...
  static final class BufferExactBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
    ...
    public void dispose() {
      ...
      //   8: monitorexit
      //   9: aload_0
      //   10: getfield upstream : Lorg/reactivestreams/Subscription;
    ...
    public void onComplete() {
      ...
      //   45: aload_0
      //   46: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   49: iconst_0
      //   50: aload_0
      //   51: aload_0
      //   52: invokestatic drainMaxLoop : (Lio/reactivex/internal/fuseable/SimplePlainQueue;Lorg/reactivestreams/Subscriber;ZLio/reactivex/disposables/Disposable;Lio/reactivex/internal/util/QueueDrain;)V
      //   55: aload_0
      //   56: getfield w : Lio/reactivex/Scheduler$Worker;
      //   59: invokevirtual dispose : ()V
      //   62: return
      //   63: astore_1
      //   64: aload_0
      //   65: monitorexit
    ...
    public void onError(Throwable param1Throwable) {
      ...
      //   8: monitorexit
      //   9: aload_0
      //   10: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   13: aload_1
    ...
    public void onNext(T param1T) {
      ...
      //   162: aload_0
      //   163: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   166: aload_1
    ...
    public void run() {
      ...
      //   76: aload_0
      //   77: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   80: aload_1
  ...
  static final class BufferExactUnboundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable, Disposable {
    ...
    public void onComplete() {
      ...
      //   56: aload_0
      //   57: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   60: iconst_0
      //   61: aconst_null
      //   62: aload_0
    ...
    public void onError(Throwable param1Throwable) {
      ...
      //   16: monitorexit
      //   17: aload_0
      //   18: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   21: aload_1
    ...
    public void onSubscribe(Subscription param1Subscription) {
      if (SubscriptionHelper.validate(this.upstream, param1Subscription)) {
        ...
        try {
          ...
          Exceptions.throwIfFatal((Throwable)param1Subscription);
          cancel();
        } 
      } 
    }
    ...
    public void run() {
      ...
      //   61: aload_0
      //   62: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   65: aload_2
  ...
  static final class BufferSkipBoundedSubscriber<T, U extends Collection<? super T>> extends QueueDrainSubscriber<T, U, U> implements Subscription, Runnable {
    ...
    public void onComplete() {
      ...
      //   81: aload_0
      //   82: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   85: iconst_0
      //   86: aload_0
    ...
    public void run() {
      ...
      //   91: aload_0
      //   92: getfield downstream : Lorg/reactivestreams/Subscriber;
      //   95: aload_1
...
/* Location:              /home/platinum/Documents/AndroidRE/com.guanxu.technology.snaptain_era_s5c_29_apps.evozi.com-dex2jar.jar!/io/reactivex/internal/operators/flowable/FlowableBufferTimed.class
